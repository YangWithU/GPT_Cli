...
func TestValidate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedError: gptclierrors.ErrInvalidModel,
		},
		{
			name:          "No messages",
			request:       &ChatCompletionRequest{},
			expectedError: gptclierrors.ErrNoMessages,
		},
		{
			name: "Invalid role",
			request: &ChatCompletionRequest{
			...
			expectedError: gptclierrors.ErrInvalidRole,
		},
		{
			...
			expectedError: gptclierrors.ErrInvalidTemperature,
		},
		{
			...
			expectedError: gptclierrors.ErrInvalidPresencePenalty,
		},
		{
			...
			expectedError: gptclierrors.ErrInvalidFrequencyPenalty,
		},
	}
